...
GFAP_res <- read.csv(paste0(pathResults, "sig_res_preadjusted_MS_vs_Ctrl_strict.csv"))  
...
selected_genes <- sample(GFAP_res_new$Gene, size = num_to_select, replace = FALSE)
