...
library(ggplot2)
pathResults1 <- ("C:\\Users\\teres\\OneDrive - Nexus365\\MSc Oxford\\Hilary Project\\Proteomics\\Astrocytes\\results\\vsnNorm\\outlierRM_ALDH1L1\\")
...
ALDH1L1_res <- read.csv(paste0(pathResults1, "sig_res_preadjusted_MS_vs_Ctrl_strict.csv"))  
